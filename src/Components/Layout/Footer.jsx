        ...
        <div className="Footer">
            <div className="mx-lg-5 px-5">
                <div className="row gx-4 gy-5">
                    <div className="col-md-12 col-lg-3 px-md-5 px-lg-0 Footer-Brand d-flex justify-content-center align-items-center">
                        <img className="Footer-Logo mb-4" src={Logo} alt="" />
                    </div>

                    <div className="col-md-7 Footer-Address">
                        <p><i class="bi bi-geo-alt-fill"></i>U102, 46 GRAINGERS ROAD, <br></br>WEST FOOTSCRAY VIC 3012</p>
                        <p><i class="bi bi-envelope-at-fill"></i>info@Digitustecglobal.com</p>
                    </div>
