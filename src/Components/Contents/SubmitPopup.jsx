...
import LogoPopup from "../../Assets/Icons/Logo_Popup.png"
        ...
        <div className="SubmitPopup">
            ...
            {!animater && (
                <div className="Submit-Alert px-4 px-sm-5 py-4">
                    ...
                    <a href={view?"https://thecyol.com/":"https://thecyol.com/dashboard/"}><button className="mt-1">Proceed to CYOL</button></a>
                </div>
            )}
        </div>
    )
