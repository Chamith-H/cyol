          ...
          <Route
            ...
            element={
              <div className="Main-Web-Site">
                ...
                >
                  <div
                    className={scrolled ? "Scrolled-Hero-Body" : "Align-Hero"}
                  />
                </div>
                ...
                <Header
                  scroll_Wanted={identity_Scroller}
                  get_Form={view_Form}
                />
              ...
              <div className="QR-Dashboard">
                ...
                <div className="Navigations px-4 px-sm-5">
                    ...
                    <div className="row g-0 Align-Background">
                      {buttons.map((button) => (
                        <div className={button.class}>
                          <a
                            href={button.navigater}
                            onClick={(e) => handle_Navigation(button.action, e)}
                          >
                            <Navbutton
                              Button={button}
                              Styler={button.subClass}
                            />
                          </a>
                        </div>
                      ))}
                  ...
                  <div className="Requesting mt-4 d-flex flex-column align-items-center">
                    ...
                    <a href="https://thecyol.com/?request=1">
